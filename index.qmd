...
::: {.box .b}
```{r forest_plot_cuernavaca, dpi = 300, fig.height= 5,fig.width = 7,fig.align = "center", out.height='100%', out.width = '100%',fig.show = "hold"}
...
::: {.box .c}
```{r power_law_plot_cuernavaca,dpi = 300, warning=FALSE, fig.align = "center", out.width = '100%',out.height='100%',fig.show = "hold"}
...
::: {.box .d}
```{r gauge_blocks_cuernavaca,fig.align = "center", out.height='90%', out.width = '90%'}
...
::: {.box .e}
```{r gauge_AGEB_cuernavaca, fig.align = "center", out.height='90%', out.width = '90%'}
...
::: {.box .f}
```{r gauge_casos_cuernavaca, out.height='90%', out.width = '90%', fig.align = "center"}
...
::: {.box .b}
```{r forest_plot_cuautla, dpi = 300, fig.height= 5,fig.width = 7,fig.align = "center", out.height='100%', out.width = '100%',fig.show = "hold"}
...
::: {.box .c}
```{r power_law_plot_cuautla,dpi = 300, warning=FALSE, fig.align = "center", out.width = '100%',out.height='100%',fig.show = "hold"}
# Step 7. make the function por calculate the cumulative ####
funcumsum <- function(x){
    x$cumulative_n <- cumsum(x$n_cases)
    x$perc_cumsum_n <- round((cumsum(x$n_cases)/sum(x$n_cases))*100, digits = 1)
...
::: {.box .d}
```{r gauge_blocks_cuautla,fig.align = "center", out.height='90%', out.width = '90%'}
y_hot <- hotspots |> dplyr::filter(hotspots_gi == 1)
centroid <- rgeomex::blocks_ine20_mx_centroid |>
  sf::st_as_sf(coords = c("x", "y"), crs = 4326)
b_loc <- centroid[hotspots, ]
...
::: {.box .e}
```{r gauge_AGEB_cuautla, fig.align = "center", out.height='90%', out.width = '90%'}
...
::: {.box .f}
```{r gauge_casos_cuautla, out.height='90%', out.width = '90%', fig.align = "center"}
...
deneggs::map_eggs_hotspots(betas = denmex::eggs_betas_17_morelos,
                           locality = c("Cuernavaca",
                                                     "Emiliano Zapata",
                                                     "Jiutepec",
                                                     "Temixco",
...
```{r vector_hotspots_cuutla, dpi = 300, warning=FALSE, message=FALSE}
deneggs::map_eggs_hotspots(betas = denmex::eggs_betas_17_morelos,
                           locality = "Cuautla",
                           cve_edo = "17",
                           palette = rcartocolor::carto_pal,
...
```{r risk_ageb_cuernavaca}
# Step 1. calculate the risk ####
denhotspots::risk_ageb(betas = denmex::eggs_betas_17_morelos,
